  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Center(child: displayProductDetails(Product: Products)),
      ),
    );
  }
}
    ...
    return Column(
      children: [
        Image(
            ...
            width: 70),
        BuildingAtext(
            txt: Product.productName, color: darkNodeColor, fontSize: 30),
        BuildingAtext(
            txt: " ${(Product.productPrice).toString()} \$",
            color: darkNodeColor,
            fontSize: 30),
        BuildingAtext(
            txt: Product.productDescription,
            color: darkNodeColor,
            fontSize: 30),
      ],
    );
