  ...
  Widget build(BuildContext context) {
    return SafeArea(child: Scaffold(
        ...
        child: Column(
            ...
            children: [
               BuildingAtext(txt: "Welcome",color: nodeColor,fontSize: 70,),
               BuildingAtext(txt: "Login",color: lightNodeColor,fontSize: 50,),
          ...
          Container(
              ...
              child: Row(
                children: [
                  BuildingAtext(txt:"Does not have an Account ? ",color:lightNodeColor,fontSize: 25),
                  FlatButton(
                    onPressed : (){
                    Navigator.pushNamed(context, RegistrationScreen.routeName);
                  }, 
                  child: BuildingAtext(txt: "Sign Up",color: lightNodeColor,fontSize: 25,)
                  )
